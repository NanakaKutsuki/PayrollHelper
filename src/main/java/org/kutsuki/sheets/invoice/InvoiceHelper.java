...
public class InvoiceHelper extends AbstractTimesheet {
    ...
    private static final String TTO_14C_SERVICE = "ITSM Alliance EIT Ops TTO-014C-2021 - COVID";
    ...
    private static final String TTO_16C_SERVICE = "ITSM Alliance EIT Ops TTO-016C-2021 - COVID";
    ...
    private static final String TTO_21_2020_RANGE = "TTO 21 2020!E2:F3";
    private static final String TTO_21_2020_SERVICE = "ITSM Alliance EIT Ops TTO-021-2020";
    ...
    private static final String TTO_24_SERVICE = "ITSM Alliance EIT Ops TTO-024-2021";
    private static final String TTO_24C_RANGE = "TTO 24C!E2:F5";
    private static final String TTO_24C_SERVICE = "ITSM Alliance EIT Ops TTO-024C-2021 - COVID";
    private static final String TTO_26_2020_RANGE = "TTO 26 2020!E2:F2";
    private static final String TTO_26_2020_SERVICE = "ITSM Alliance EIT Ops TTO-026-2020";
	...
	try {
	    ...
	    updateITSM(TTO_21_2020_RANGE, TTO_21_2020_SERVICE, 2023693587, -1747439098);
	    ...
	    updateITSM(TTO_26_2020_RANGE, TTO_26_2020_SERVICE, 1973893852);
